...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Vérification basique avant l'envoi (optionnelle)
    if (!dataContact.nom || !dataContact.email || !dataContact.message) {
      ...
      const response = await fetch("http://localhost:5000/api/contact", {
        ...
        body: JSON.stringify(dataContact), // contient { name, email, message }
      });

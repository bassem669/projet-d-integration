...
export default function ForumEnseignant() {
  ...
  if (loading) {
    return (
      <div className="content px-4 text-center py-5">
    ...
    <div className="content flex-grow-1 px-4">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h4 className="d-flex align-items-center">
          <FaComments className="me-2 text-primary" /> Forum – Réponses Enseignant
        </h4>
        ...
        <div className="card-body">
          <form onSubmit={handleSendMessage}>
            <textarea
              ...
              placeholder="Écrire une réponse en tant qu'enseignant..."
              rows="3"
              value={newMessage}
            ...
            <button className="btn btn-primary w-100 d-flex align-items-center justify-content-center">
              <FaPaperPlane className="me-2" /> Envoyer la réponse
            </button>
          </form>
        </div>
      </div>
